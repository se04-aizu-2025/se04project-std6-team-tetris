    ...
    <>
      ...
      <div className="step-controls motion-in">
        ...
        <div className="reset-controls">
          ...
          <button className="btn" onClick={resetAll} disabled={autoMode !== null} type="button">
            Reset All
          </button>
          <button className="btn btn-primary" onClick={showFinal} disabled={autoMode !== null} type="button">
            Show Final Result
          </button>
        </div>
      </div>
